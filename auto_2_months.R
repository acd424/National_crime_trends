automated_2_months = function(data,crime,march,april, All = FALSE, graph = TRUE ){
  ...
  this_years_data_updated = c(this_years_data,march,april)
  last_two_years_data_updated = c(last_two_years_data, march,april)
  
  
  x = all_years_data$n/pop_ests$pop[1:60]
  
  fitARIMA <- auto.arima(ts(x, 12), trace=FALSE, stepwise = FALSE, approximation = FALSE)
  

  
  futurVal <- forecast(fitARIMA,h=2, level=c(95.0))
  ...
  actual = last_two_years_data_updated/pop_ests$pop[37:62]
  

  Month = factor(c("Mar 18" , "Apr 18", "May 18", "Jun 18", "Jul 18", "Aug 18", "Sep 18", "Oct 18", "Nov 18", "Dec 18",'Jan 19' , "Feb 19","Mar 19" , "Apr 19", "May 19", "Jun 19", "Jul 19", "Aug 19", "Sep 19", "Oct 19", "Nov 19", "Dec 19", 'Jan 20' , "Feb 20", "Mar 20", "Apr 20"), 
                 levels = c("Mar 18" , "Apr 18", "May 18", "Jun 18", "Jul 18", "Aug 18", "Sep 18", "Oct 18", "Nov 18", "Dec 18",'Jan 19' , "Feb 19","Mar 19" , "Apr 19", "May 19", "Jun 19", "Jul 19", "Aug 19", "Sep 19", "Oct 19", "Nov 19", "Dec 19", 'Jan 20' , "Feb 20", "Mar 20", "Apr 20"))
